...
public class MatchQueryTest {
    ...
    private static final MatchFilter A_MATCH_FILTER = MatchFilter.SPORT;
    private static final String A_FILTER_VALUE = "Soccer";
    private static final String ANOTHER_FILTER_VALUE = "Football";
    private static final MatchFilter ANOTHER_MATCH_FILTER = MatchFilter.VENUE;
    ...
    public void newQueryHasNoFilter() {
        Map<MatchFilter, List<Object>> query = aMatchQuery.getQuery();
