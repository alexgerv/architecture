...
public class QueryResolverTest {
    ...
    private static final List<FilterCategories> A_LIST_OF_VALID_FILTER_CATEGORIES = Arrays.asList(FilterCategories.CATEGORY1,
                                                                                                  FilterCategories.CATEGORY2);
    ...
    private static final List<String> A_LIST_OF_IDENTIFIER_FOR_CATEGORY1_FILTER1 = Arrays.asList(IDENTIFIER1,
                                                                                                 IDENTIFIER2);
    private static final List<String> A_LIST_OF_IDENTIFIER_FOR_CATEGORY1_FILTER2 = Arrays.asList(IDENTIFIER3,
                                                                                                 IDENTIFIER4);
    private static final List<String> A_LIST_OF_IDENTIFIER_FOR_CATEGORY2_FILTER1 = Arrays.asList(IDENTIFIER1,
                                                                                                 IDENTIFIER5);
    ...
    private QueryResolver<FilterCategories, ConcreteIndexable> queryResolver;
    ...
    public void setup() {
        ...
        queryResolver = new QueryResolver<FilterCategories, ConcreteIndexable>(anIndex);
    }
    ...
    public void whenAskingIdentifiersForAQueryAllIdentifierForSameCategoryAreReturned() {
        ...
        doReturn(A_LIST_OF_IDENTIFIER_FOR_CATEGORY1_FILTER1).when(anIndex)
                                                            .getIdentifiersFor(FilterCategories.CATEGORY1, FILTER1);
        doReturn(A_LIST_OF_IDENTIFIER_FOR_CATEGORY1_FILTER2).when(anIndex)
                                                            .getIdentifiersFor(FilterCategories.CATEGORY1, FILTER2);
    ...
    public void whenAskingIdentifiersForAQueryReturnedIdentifiersIsTheIntersectionBetweenCategories() {
        ...
        doReturn(A_LIST_OF_IDENTIFIER_FOR_CATEGORY1_FILTER1).when(anIndex)
                                                            .getIdentifiersFor(FilterCategories.CATEGORY1, FILTER1);
        doReturn(A_LIST_OF_IDENTIFIER_FOR_CATEGORY2_FILTER1).when(anIndex)
                                                            .getIdentifiersFor(FilterCategories.CATEGORY2, FILTER1);
